...
const HomePage = () => {
  return (
    <div className="min-h-screen bg-light-gray-bg bg-gray-300 font-sans  text-dark-text">
      ...
      <div className="bg-white shadow-sm py-4">
        <div className="container mx-auto px-4 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-6 text-gray-700 font-medium">
            ...
            <Link to="/register" className="bg-blue-500 text-white font-semibold py-2 px-5 rounded-lg shadow-md hover:bg-blue-600 transition duration-300">
              Register
            </Link>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="w-full md:w-1/2 text-center md:text-left mb-12 md:mb-0">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-dark-text leading-tight mb-4">
              Find your perfect <br className="hidden sm:inline"/> government job faster
            </h1>
            <p className="text-base sm:text-lg text-gray-text mb-8 max-w-md mx-auto md:mx-0">
              We help you to find the perfect government job fast and get alerts. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odio. Praesent libero.
            </p>
      ...
      >
        Login
          ...
          <div className="w-full md:w-1/2 flex justify-center md:justify-end">
            <img
              src='/public/images/hero.jpg.png' // Placeholder
      ...
      <section className="py-16 bg-light-gray-bg">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl font-bold text-dark-text text-center mb-10">How It Works</h2>
 ...
 <footer className="bg-white py-10 mx-40 mt-12 shadow-inner">
      <div className="container mx-auto px-4 text-center text-gray-600">
        <div className="mb-4">
          <a href="#" className="text-gray-700 hover:text-primary mx-3 transition duration-300">Privacy Policy</a>
          <span className="text-gray-400">|</span>
          <a href="#" className="text-gray-700 hover:text-primary mx-3 transition duration-300">Terms of Service</a>
          <span className="text-gray-400">|</span>
          <a href="#" className="text-gray-700 hover:text-primary mx-3 transition duration-300">Contact Us</a>
        </div>
        <p>&copy; {new Date().getFullYear()} GOVTCAREERS. All rights reserved.</p>
        <p className="mt-2 text-sm text-gray-500">Designed with passion for public service aspirants.</p>
      </div>
    </footer>
